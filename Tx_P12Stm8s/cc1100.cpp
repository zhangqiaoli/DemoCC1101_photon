...
static uint8_t patable_power_433[] = {0xc0,0xC8,0x84,0x60,0x68,0x34,0x1D,0x0E};
...
uint8_t CC1100::begin(volatile uint8_t &My_addr)
{
    ...
    set_myaddr(0x00);                  //My_Addr from EEPROM to global variable
    */
    if(debug_level > 0){
                            ...
                            uint8_t pktlen,  uint8_t tx_retries)
{
    ...
    {
        Serial.print("ERROR: package size overflow\r\n");
        return FALSE;
    }
...
void CC1100::set_mode(uint8_t mode)
{
    ...
    {
        /*case 0x01:
                    memcpy(Cfg_reg,cc1100_GFSK_1_2_kb,CFG_REGISTER);   //sets up settings for GFSK 1,2 kbit mode/speed
                    break;
        case 0x02:
                    memcpy(Cfg_reg,cc1100_GFSK_38_4_kb,CFG_REGISTER);  //sets up settings for GFSK 38,4 kbit mode/speed
                    break;
        case 0x03:
...
void CC1100::set_ISM(uint8_t ism_freq)
{
    ...
    switch (ism_freq)                                                       //loads the RF freq which is defined in cc1100_freq_select
    {
        ...
        case 0x03:                                                          //868MHz
                    ...
                    freq1=0x62;
                    freq0=0x76;
                    memcpy(Patable,patable_power_868,8);
                    break;
        case 0x04:                                                          //915MHz
                    freq2=0x23;
                    freq1=0x31;
                    freq0=0x3B;
                    memcpy(Patable,patable_power_915,8);
                    break;
        /*
        case 0x05:                                                          //2430MHz
                    freq2=0x5D;
        ...
        */
        default:                                                             //default is 868.3MHz
                    ...
                    freq1=0x65;
                    freq0=0x6A;
                    memcpy(Patable,patable_power_868,8);          //sets up output power ramp register
                    break;
    }
...
void CC1100::setSyncWord( uint16_t Sync )
{
    ...
    spi_write_register( SYNC0, 0xFF & Sync );   //Ð´ÈëÍ¬²½×Ö¶Î 16Bit
}
